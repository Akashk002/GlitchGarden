...
public class CactusStateMachine : IStateMachineDefender
{
    ...
    public CactusStateMachine(DefenderController defenderController)
    {
    ...
    private void CreateState()
    {
        ...
        States.Add(DefenderStates.Attack, new DefenderAttackState(this));
